    ...
    <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
                  ...
                  <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mx-4">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="flex-1">
                        {/* Quote Icon */}
                        <div className="mb-6">
                          <Quote className="w-12 h-12 text-blue-500 opacity-30" />
                        </div>
                      ...
                      {/* Product Badge */}
                      <div className="bg-gradient-to-br from-blue-500 to-purple-600 text-white p-6 rounded-2xl text-center min-w-[200px]">
                        <div className="text-sm text-blue-100 mb-2">Riding</div>
                        <div className="text-lg font-bold mb-4">{testimonial.bikeModel}</div>
          ...
          <button
            onClick={prevSlide}
            className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:shadow-xl transition-all duration-200 z-10"
          >
            <ChevronLeft className="w-6 h-6 text-gray-600" />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white shadow-lg rounded-full p-3 hover:shadow-xl transition-all duration-200 z-10"
          >
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
            ...
            <button className="bg-white text-blue-600 font-bold px-8 py-4 rounded-full text-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
              Shop E-Bikes Now
            </button>
          </div>
        </div>
