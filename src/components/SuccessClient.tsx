  ...
  if (error) return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-6">
      <div className="max-w-xl bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <button 
          onClick={() => router.push('/')} 
          className="px-6 py-3 bg-yellow-500 text-white rounded-xl font-semibold hover:bg-yellow-600 transition-all duration-200 shadow-lg"
        >
      ...
      <div className="max-w-xl w-full mt-32">
        <div className="bg-white rounded-2xl shadow-xl p-6 text-center relative overflow-hidden">
          ...
          <div className="relative mb-6">
            <div className="w-20 h-20 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => router.push('/')} 
              className="px-8 py-3 bg-yellow-500 text-white rounded-xl font-semibold hover:bg-yellow-500 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              Fortsett å handle
            </button>
            <button 
              onClick={() => router.push('/contact')} 
              className="px-8 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-semibold hover:border-yellow-500 hover:text-yellow-500 transition-all duration-200"
            >
              Kontakt oss
            </button>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <a href="mailto:support@jobobike.no" className="text-yellow-500 hover:underline font-medium">
              support@jobobike.no
            </a>
          </p>
        </div>
