              ...
              <div className="mt-2 flex flex-col sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="mt-2 sm:mt-0 flex flex-col sm:flex-row sm:items-center gap-2">
                  ...
                  <AddToCartButton
                    ...
                    className="w-full sm:flex-1 rounded-full border border-gray-300 px-1 sm:px-3 py-1 sm:py-1.5 text-xs font-medium text-white bg-yellow-500 hover:bg-yellow-500 transition sm:bg-black sm:hover:border-black sm:hover:bg-gray-50 sm:hover:text-black whitespace-nowrap"
                  />
                </div>
              </div>
            </li>
