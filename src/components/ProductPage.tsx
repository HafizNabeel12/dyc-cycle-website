    ...
    <main className="bg-white text-gray-900 mt-32">
      ...
      <section className="mx-auto max-w-7xl px-4 pt-6">
        <header className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-black">Sykkel</h1>
          ...
          {products.map((product) => (
            <li key={product.id} className="group rounded-2xl border border-gray-200 p-3 transition hover:border-black">
              ...
              <div className="mt-2 flex items-end justify-between">
                ...
                <button className="rounded-full border border-gray-300 px-3 py-1.5 text-xs font-medium text-black transition hover:border-black hover:bg-gray-50">
                  Legg i handlekurv
                </button>
              </div>
