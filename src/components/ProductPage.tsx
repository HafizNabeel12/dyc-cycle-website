              ...
              <div className="mt-2 flex items-end justify-between">
                ...
                <div className="mt-2 flex items-end justify-between">
                  <div>
                    ...
                    <AddToCartButton product={product}  className="w-36 rounded-full border border-gray-300 px-3 py-1.5 text-xs font-medium text-white transition hover:border-black hover:bg-gray-50"/>
